    ...
    return (
        <>
            <main id="why-us" className="why-us-container">
                ...
                <img className="why-us-banner" src="./src/assets/Wedding Card.png" alt="Img Not Available" />
                <div className="why-us-content">
                    <div className="why-us-content__item">
                        <span className="why-us-content__icon">
                            <img className="why-us-content__image" src="./src/assets/Icon-Delivery.png" alt="Professional Designs" />
                        </span><br/>
                        <h5 className="why-us-content__subtitle">On-Time Delivery</h5>
                    </div>
                    <div className="why-us-content__item">
                        <span className="why-us-content__icon">
                            <img className="why-us-content__image" src="./src/assets/Icon-Support.png" alt="Professional Designs" />
                        </span><br/>
                        <h5 className="why-us-content__subtitle">Friendly Support</h5>
                    </div>
                    <div className="why-us-content__item">
                        <span className="why-us-content__icon">
                            <img className="why-us-content__image" src="./src/assets/Icon-Monitor.png" alt="Professional Designs" />
                        </span><br/>
