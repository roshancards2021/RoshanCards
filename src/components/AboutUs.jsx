    ...
    return (
        <>
            ...
            <main className="about-us-container">
                ...
                <img className="about-us-banner" src="./src/assets/Banner - 1.png" alt="Img Not Available" />
                <div className="about-us-content">
                    <div className="about-us-content__item">
                        <span className="about-us-content__icon">
                            <img className="about-us-content__image" src="./src/assets/Icon-Compass.png" alt="Professional Designs" />
                        </span><br/>
                        <h5 className="about-us-content__subtitle">Professional Designs</h5>
                    </div>
                    <div className="about-us-content__item">
                        <span className="about-us-content__icon">
                            <img className="about-us-content__image" src="./src/assets/Icon-WeddingCard.png" alt="High Quality Cards" />
                        </span><br/>
                        <h5 className="about-us-content__subtitle">High Quality Cards</h5>
                    </div>
                    <div className="about-us-content__item">
                        <span className="about-us-content__icon" id="multicolor-icon">
                            <img className="about-us-content__image" src="./src/assets/Icon-Gallery.png" alt="Multicolor Printing" />
                        </span><br/>
